                    ...
                    "columns": [{
...

                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                } else if (ultimoEstado == "TRÁMITE" || ultimoEstado == "VALIDADO") {
                                    var Estado =
                                                ...
                                                <div class="col-md-12 col-lg-10">
                                                    <div class="row g-0 text-center">
                                                        ...
                                                        <div class="row g-0 align-items-center justify-content-center border p-2">
                                                            ${row.UltimoEstado == "TRÁMITE" || row.UltimoEstado == "VALIDADO"?
                                            ...
                                            ${
                                                row.historial
                                                    ...
                                                    .map(item => {
                                                        ...
                                                        if (item.Estado === 'TRÁMITE' || item.Estado === 'DONE' || item.Estado === 'REMITIDO') {
                                                            return `
                                            <div class="row g-0 text-center">
                                                        ...
                                                        <div class="collapse" id="secondaryData_${id}">
                                                            <div class="row g-0 row-cols-2 d-flex justify-content-start">
                                                                <div class="col-sm-6 col-md-9 col-lg-9 d-flex align-items-center justify-content-start border p-2">
                                                                    ${row.UltimoEstado == 'CORREGIR' && item.Estado !== 'DONE'  ? `
                                                                        <div class="mb-3 w-100" id="id">
                                                                            <select class="form-select form-select-lg" name="tautorizacionmodal" id="autorizacionesmodal${row.IDAutorizacion}" 
                                                                                onChange="autorizacionesModalChange(${row.IDAutorizacion},'${row.Cedula}','${row.CuentaAsociado}', '${row.NombrePersona}', '${row.Convencion}', event)" required>
                                                                ...
                                                                <div class="col-sm-6 col-md-3 col-lg-3 d-flex align-items-center justify-content-center border p-3">
                                                                    ${row.ID_Concepto == 41 ? `<span class="fs-5 fw-bold mb-0">@include('layouts.optionverconvenciones') - ${row.Convencion}</span>` : ``}
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <div class="row g-0">
                                                                                ...
                                                                                <div class="col-md-12 d-flex justify-content-start border p-2" id="inputs${row.IDAutorizacion}">
                                                                                    <span class="fs-5">${cedula}
                                                                                        ...
                                                                                        ${
                                                                                            row.Score >= 650
                                                                                                ? `<span class="badge bg-success text-light fw-bold">${row.Score}</span> - ${estado}`
                                                                                                : (row.Score === 'S/E'
                                                                                                    ? `<span class="badge bg-warning text-dark fw-bold">${row.Score}</span> - ${estado}`
                                                                                                    : `<span class="badge bg-danger text-light fw-bold">${row.Score}</span> - ${estado}`)
                                                                                        }
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                ${row.UltimoEstado == 'CORREGIR' && item.Estado != 'DONE' ? `
                                                                    <div class="col-sm-12 col-md-9 text-start border p-2 fs-5">
                                                                        <textarea class="mb-0 w-100" style="resize: vertical; height: 100px; border-radius: 10px" 
                                                                            id="Detalle" name="Detalle_${row.IDAutorizacion}" required>${row.Detalle}</textarea>
                                                                    </div>
                                                                    <div class="col-sm-12 col-md-3 d-flex align-items-center justify-content-center p-3">
                                                                        ...
                                                                        <input class="input" name="Soporte_${row.IDAutorizacion}" id="file_${row.IDAutorizacion}" 
                                                                            type="file" accept="application/pdf" onchange="fileUploaded(${row.IDAutorizacion})" />
                                            ...
                                            <div class="row g-0 text-center">
                                                <div class="col-sm-12 col-md-12 col-lg-2 d-flex align-items-center justify-content-center ${
                                                    ...
                                                    <span class="h1 fw-bold mb-0">
                                                        ${item.Estado[0]}<br>
                                                        <span class="fs-5 fw-normal">${item.Estado}</span>
                                                    </span>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-lg-10">
                                                    <div class="row g-0">
