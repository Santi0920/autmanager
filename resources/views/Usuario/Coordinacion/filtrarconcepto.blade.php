            ...
            <table id="personas" class="hover table table-striped shadow-lg mt-4 table-hover table-bordered">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control filter-input fs-4 fw-bold" name="" id="" placeholder="C.c" data-column="3" />
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text" class="form-control filter-input fs-4 fw-bold" name="" id="" placeholder="OBSERVACIONES GER" data-column="11" />
                        </td>
                        <td>
                            <input type="text" class="form-control filter-input fs-4 fw-bold" name="" id="" placeholder="FECHA APROBACION" data-column="12" />
                        </td>
                    </tr>
        ...
        var table = $('#personas').DataTable({
            ...
            "columns": [{
...

                {
                    ...
                    render: function(data, type, row) {
                        var dato =
                            `${row.UltimaCuentaAsociado}`

                            if(row.UltimaCuentaAsociado == null){
                            return 'N/A'
                        }else{
                            return dato
                        }
...

                {
                    data: null,
                    render: function(data, type, row) {
                        var textoCorto = row.UltimoDetalle.substring(0, 100); // Ajusta el número de caracteres
                        var textoCompleto = row.UltimoDetalle;
...

                {
                    ...
                    render: function(data, type, row) {
                        var dato =
                            `${row.UltimaConvencion}`

                        if(row.UltimaConvencion == null){
                            return 'N/A'
                        }else{
                            return dato
                        }
...

                {
                    ...
                    render: function(data, type, row) {
                        var dato =
                            `${row.UltimasObservacionesAprobado}`

                        if(row.UltimasObservacionesAprobado==null){
                            return 'Ninguna.'
                        }else{
                            return dato
                        }
