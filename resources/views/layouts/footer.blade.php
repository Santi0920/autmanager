    ...
    <footer class="mt-2">
        <div class="container-fluid">
            <div class="row p-5 pb-2 text-white text-left" style="background-color: #646464;">
                ...
                <div class="col-xs-12 col-md-6 col-lg-3 aling-elements">
                    ...
                    <div class="mb-2">
                        <a href="http://app.coopserp.com/menu-datacredito/inicia-sesion" class="text-light text-decoration-none" target="__blank">Datacrédito</a>
                    </div>
                </div>
                <div class="col-xs-12 col-md-6 col-lg-3">
                ...
                <div class="col-xs-12 col-md-6 col-lg-3">
                    ...
                    {{-- <div class="mb-2">
                        <a href="#" class="text-light text-decoration-none"><i class="bi bi-instagram"></i>
                            Instagram</a>
                    </div>
                    <div class="mb-2">
                        <a href="#" class="text-light text-decoration-none"><i class="bi bi-twitter"></i>
                            Twitter</a>
                    </div> --}}
                    <div class="mb-2">
                        <a href="https://github.com/Santi0920/Coopserp"
                            class="text-light text-decoration-none">Github</a>
                    </div>
                </div>
                <p class="text-center text-white mt-4">Coopserp Web &copy; <?php echo date('Y'); ?> Diseñado y Desarrollado
