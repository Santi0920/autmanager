...
<body>
    <section class="vh-100 shadow-lg" style="background: rgb(0,94,86);
                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form method="POST">
                        ...
                        <div class="text-center mb-3 pb-1 img-fluid">
                            <img src="img/Logo-Coopserp.png"
                            alt="LOGO COOPSERP" class="" style="height: 7.2rem; width: 17.5rem" />
                        </div>

                        <h2 class="fw-normal mb-3 pb-3 fw-bold" style="letter-spacing: 1px;">Iniciar Sesión</h2>
